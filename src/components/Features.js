...
const Features = () => {
  return (
    <>
      <div
        className="max-w-6xl h-screen flex flex-col justify-center items-center mx-auto lg:px-2 "
        id="/features"
      >
        ...
        <div className="flex flex-row mt-10">
          <div className="relative w-48 h-52 flex flex-col  break-words  mb-6 shadow-lg rounded-lg bg-gray-300 shadow-gray-400 shadow-r- mx-3.5">
