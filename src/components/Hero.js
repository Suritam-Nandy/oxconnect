            ...
            <div className="flex flex-col justify-center mr-1 row-start-2 md:col-start-1 md:row-start-1">
              ...
              <div className="flex flex-row justify-center mt-8">
                <div className="mr-4 p-2">
                  <h1 className="text-2xl font-medium text-black my-2">
                    Applicant
                  </h1>
                  <p className="mb-4">
                  ...
                  <div className="p-2 flex justify-between items-center">
                    <button className="bg-gray-800 text-gray-300 hover:text-white hover:border-2 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                      Create Profile
                    </button>
                  </div>
                </div>
                <div className="mr-4 p-2">
                  ...
                  <div className="p-2 flex justify-between items-center">
                    <button className="  border border-gray-700 text-gray-700 bg-white hover:text-black hover:border-2 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                      Sign up
                    </button>
                  </div>
                </div>
